...
- Generally, before developing enhancements to this charm, you should
  consider [opening an issue](https://github.com/canonical/identity-saml-provider-operator/issues)
...
# Deploy the charm
juju deploy ./identity-saml-provider-operator_ubuntu@24.04-amd64.charm --resource oci-image=$(yq eval '.resources.oci-image.upstream-source' charmcraft.yaml) --trust
```
